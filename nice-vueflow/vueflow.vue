...
export default {
    mounted() {
      const vf = window.VueFlowCore.VueFlowCore;
      const flow = vf.useVueFlow();
      console.log( flow );
      // vf.$forceUpdate();
      console.log( flow.$forceUpdate );
    },
    props: {
        options: Object,
        elements: Object
    ...
    methods: {
      ...
      <!-- const vueflowmodule = document.createElement("script");
      vueflowmodule.setAttribute(
        "src",
        "lib/vueflow/vue-flow-core.iife.js"
      );
      vueflowmodule.async = true;
      document.head.appendChild(vueflowmodule); -->
